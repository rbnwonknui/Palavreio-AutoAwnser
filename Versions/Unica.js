(function() {
                    ...
                    <div class="palavreio-content">
                        <div class="palavreio-section">
                            ...
                            <p class="palavreio-text">
                                Bem-vindo ao <strong>Palavreio Helper</strong>! Esta automação detecta automaticamente a palavra correta do jogo através do localStorage e exibe uma notificação elegante na tela.
                            </p>
                            <p class="palavreio-text">
    ...
    // Função para extrair a palavra do localStorage
    function extractWordFromStorage() {
        ...
        try {
            ...
            const word = parsedData.columns?.[0]?.goalWord?.palavra;
            
            if (!word) {
                console.warn('🎯 Palavreio Helper: Campo "palavra" não encontrado nos dados.');
                return null;
            }
    ...
    function initialize() {
        ...
        const closeModal = () => {
            ...
            setTimeout(() => {
                overlay.remove();
                // Mostrar palavra após fechar o modal
                const word = extractWordFromStorage();
                if (word) {
                    showWordNotification(word);
                    console.log(`🎯 Palavreio Helper: Palavra encontrada - ${word}`);
                } else {
